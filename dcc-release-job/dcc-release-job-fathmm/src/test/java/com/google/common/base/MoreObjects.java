...
public final class MoreObjects {
   ...
   *
   * <p>
   * <b>Note:</b> if {@code first} is represented as an {@link Optional}, this can be accomplished with
   * {@link Optional#or(Object) first.or(second)}. That approach also allows for lazy evaluation of the fallback
   * instance, using {@link Optional#or(Supplier) first.or(supplier)}.
   *
  ...
  /**
   * Creates an instance of {@link ToStringHelper} in the same manner as {@link #toStringHelper(Object)}, but using the
   * simple name of {@code clazz} instead of using an instance's {@link Object#getClass()}.
   *
   * <p>
   * Note that in GWT, class names are often obfuscated.
   *
  ...
  public static final class ToStringHelper {
    ...
    /**
     * Configures the {@link ToStringHelper} so {@link #toString()} will ignore properties with null value. The order of
     * calling this method, relative to the {@code add()}/{@code addValue()} methods, is not significant.
     *
    ...
    /**
     * Adds a name/value pair to the formatted output in {@code name=value} format. If {@code value} is {@code null},
     * the string {@code "null"} is used, unless {@link #omitNullValues()} is called, in which case this name/value pair
     * will not be added.
     */
     ...
     * complete representation of the same object; but properties cannot be removed, so this only allows limited reuse
     * of the helper instance. The helper allows duplication of properties (multiple name/value pairs with the same name
     * can be added).
     */
    @Override
