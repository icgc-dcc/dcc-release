...
public class SumDataType implements
    Function2<Tuple3<KeyValue[], Long, Integer>, Tuple3<KeyValue[], Long, Integer>, Tuple3<KeyValue[], Long, Integer>> {

  @Override
  public Tuple3<KeyValue[], Long, Integer> call(Tuple3<KeyValue[], Long, Integer> tuple1,
      Tuple3<KeyValue[], Long, Integer> tuple2) throws Exception {
